this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var Ha = new Date(2022, 1, 20, 0, 0, 0, 0);
    ...
    var Za = "IN_PROGRESS",
        ...
        ts = function(e) {
            ...
            function t() {
                ...
                var o = za();
                return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(NUM_GUESSES).fill(""), e.evaluations = new Array(NUM_GUESSES).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja({
                    rowIndex: e.rowIndex,
            ...
            return o(t, [{
                key: "evaluateRow",
                value: function() {
                    if (NUM_LETTERS === this.tileIndex && !(this.rowIndex >= NUM_GUESSES)) {
                        var e, a = this.$board.querySelectorAll("game-row")[this.rowIndex],
                            s = this.boardState[this.rowIndex];
                        if (e = s, !guessList.includes(e) && !wordList.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not in word list");
                        if (this.hardMode) {
                        ...
                        var i = this.rowIndex >= NUM_GUESSES,
                ...
                key: "addLetter",
                value: function(e) {
                    this.gameStatus === Za && (this.canInput && (this.tileIndex >= NUM_LETTERS || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
                }
            }, {
                key: "removeLetter",
                value: function() {
                ...
                value: function() {
                    if (this.gameStatus === Za && this.canInput) {
                        if (NUM_LETTERS !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Not enough letters");
                        this.evaluateRow()
                    }
                }
            }, {
                ...
                value: function() {
                    var e = this.shadowRoot.querySelector("#board-container"),
                        a = Math.min(Math.floor(e.clientHeight * (NUM_LETTERS / NUM_GUESSES)), 350),
                        s = NUM_GUESSES * Math.floor(a / NUM_LETTERS);
                ...
                value: function() {
                    ...
                    this.gameStatus === es && this.rowIndex <= NUM_GUESSES && a.setAttribute("highlight-guess", this.rowIndex), a.gameApp = this, e.appendChild(a), e.setAttribute("open", "")
                }
            }, {
                key: "showHelpModal",
                value: function() {
                ...
                value: function() {
                    ...
                    this.$game.addEventListener("game-key-press", (function(a) {
                        ...
                        e.$keyboard.letterEvaluations = e.letterEvaluations, e.rowIndex < NUM_GUESSES && (e.canInput = !0);
                        ...
                        p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                            ...
                            As(function(e) {
                                var a = e.evaluations,
                                    ...
                                    i = JSON.parse(window.localStorage.getItem(S)),
                                    l = 'Wordle' + NUM_LETTERS + ' ' + s;
                                l += " ".concat(n ? t : "X", "/").concat(NUM_GUESSES), o && (l += "*");
                                var d = "";
